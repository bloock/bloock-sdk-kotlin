//[docs](../../../index.md)/[com.enchainte.sdk](../../index.md)/[EnchainteClient](../index.md)/[Companion](index.md)
...
|  Name|  Summary| 
|---|---|
| <a name="com.enchainte.sdk/EnchainteClient.Companion/VERSION/#/PointingToDeclaration/"></a>[VERSION](-v-e-r-s-i-o-n.md)| <a name="com.enchainte.sdk/EnchainteClient.Companion/VERSION/#/PointingToDeclaration/"></a> [jvm] const val [VERSION](-v-e-r-s-i-o-n.md): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
